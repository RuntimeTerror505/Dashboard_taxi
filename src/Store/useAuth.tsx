...
export const useAuth = create<Store>((set) => ({
    ...
    login: async (data) =>{
        ...
        const res = await axios.post('http://localhost:7010/auth/login', data).then(res => res.data)
    ...
    registration: async (data) =>{
        ...
        const res = await axios.post('http://localhost:7010/auth/registration', data).then(res => res.data)
