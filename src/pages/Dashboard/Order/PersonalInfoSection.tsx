        ...
        <div className={personalInfo}>
            ...
            <main className={main}>
                ...
                <section className={section}>
                    ...
                    <div className={names < 2 ?addNameBtn: 'hidden'} onClick={() => setNames(names+1)}>+ name</div>
                </section>
                ...
                <section className={section}>
                    ...
                    <div className={emails <2 ? addNameBtn: 'hidden'} onClick={() => setEmails(emails+1)}>+ email</div>
                ...
                <section className={section}>
                    ...
                    <div className={phones < 2 ? addNameBtn: 'hidden'} onClick={()=>setPhones(phones+1)}>+ phone</div>
                </section>
